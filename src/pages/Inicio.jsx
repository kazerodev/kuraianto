...
function Inicio() {
  ...
  return (
    <div className="bg-neutral-950 overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 xl:gap-16 items-center">
            ...
            <div className="lg:hidden col-span-full grid grid-cols-2 gap-3">
              {t.hero.card_items.map((item, i) => {
                ...
                return (
                  <div key={item.title} className="rounded-xl p-4" style={{ border: "1px solid rgba(255,255,255,0.07)", background: "rgba(255,255,255,0.025)" }}>
                    <span className="text-[10px] font-black tabular-nums block mb-2" style={{ color: "rgba(249,115,22,0.5)" }}>0{i + 1}</span>
                    <p className="text-white font-bold text-xs leading-snug mb-1.5">{item.title}</p>
                    <p className="text-orange-400 text-[11px] font-bold">{price}</p>
                  </div>
                );
              })}
            </div>
      ...
      {/* ── CONTACT ──────────────────────────────────────────── */}
      <section id="contacto" className="relative bg-neutral-900 py-24 overflow-hidden">
